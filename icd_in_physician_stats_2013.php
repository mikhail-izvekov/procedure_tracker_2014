...
echo "<h2>Inpatient ICD Procedure Summary Per Physician 2013</h2>";
/******************END PROCESS SUBMITTED FORM***********************/


$filter =  "<form method='post' action='icd_in_physician_stats_2013.php'>";
...
$icd_counts = getIN_ICD_Stats_perPhysician2013($icd_code);
