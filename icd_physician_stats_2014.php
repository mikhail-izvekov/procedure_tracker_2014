...
echo "<h2>ICD Procedure Summary Per Physician 2014</h2>";
/******************END PROCESS SUBMITTED FORM***********************/


$filter =  "<form method='post' action='icd_physician_stats_2014.php'>";
...
$icd_counts = getICD_Stats_perPhysician($icd_code);
