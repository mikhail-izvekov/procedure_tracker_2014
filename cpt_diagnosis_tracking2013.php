...
echo "<h2>CPT Diagnosis Tracker 2013</h2>";
/******************END PROCESS SUBMITTED FORM***********************/


$filter =  "<form method='post' action='cpt_diagnosis_tracking2013.php'>";
...
$filter .= "<input type='checkbox'       name='cpt_breakdown'      $cpt_checked      >&nbsp;By ICD Code";
...
$cpt_counts = getCPTDiagnosCount($db, $cpt_code, $cpt_breakdown, $state_breakdown,  $city_breakdown, $pls_breakdown, $per_breakdown);
