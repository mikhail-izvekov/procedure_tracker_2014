...
echo "<h2>Inpatient ICD Diagnosis Tracker 2013</h2>";
/******************END PROCESS SUBMITTED FORM***********************/


$filter =  "<form method='post' action='icd_in_diagnosis_tracking2013.php'>";
...
$icd_counts = getIN_ICDDiagnosis2013($icd_code, $state_breakdown,  $city_breakdown, $inout_breakdown, $hospital_breakdown, $at_breakdown, $op_breakdown );
