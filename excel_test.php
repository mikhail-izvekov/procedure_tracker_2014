...
echo "<h2>ICD Procedure Summary Per Hospital 2014</h2>";
/******************END PROCESS SUBMITTED FORM***********************/


$filter =  "<form method='post' action='excel_test.php'>";
...
?>
<input type="button" onclick="tableToExcel('itsthetable', 'ICD_Procedure_Stats')" class="excel_button" value="Export"><table id='itsthetable'>
<?php
...
$icd_counts = getICD_Stats_perHospital($icd_code);
